...
import { groupBySKU } from "@/lib/groupedBySku"
  ...
  return (
    <div className="max-w-7xl mx-auto">
            ...
            <li key={sku} className="p-5 my-2 flex items-center justify-between">
               ...
               <div className="flex space-x-4 pl-4">
                    <div>
                        ...
                        className="line-clamp-1 text-sm font-light mt-2"/>
                    </div>
        ...
        <div className="flex flex-col justify-end p-5">
            <p className="font-bold text-2xl text-right text-wallmart mb-5">
                Total: {basketTotal}
            </p>
            <Button className="mt-5 h-10 bg-wallmart hover:bg-wallmart/50">Checkout</Button>
        </div>
